...
private fun CompanionContent(
    ...
    when (status.rootState) {
        ...
        CompanionRootState.ProfileMismatch -> RecoveryScreen(
            symbol = "≠",
        ...
        CompanionRootState.Incompatible -> RecoveryScreen(
            symbol = "↑",
        ...
        CompanionRootState.Revoked -> RecoveryScreen(
            symbol = "×",
        ...
        -> if (hasSnapshot) {
            ...
            RecoveryScreen(
                ...
                title = if (status.rootState == CompanionRootState.Unreachable) {
                    "Rotki is out of reach"
                } else {
                    "Preparing your portfolio"
                },
                message = if (status.rootState == CompanionRootState.Unreachable) {
                ...
                actionLabel = if (status.rootState == CompanionRootState.Unreachable) {
                    "Try again"
                } else {
                    null
                },
                onAction = if (status.rootState == CompanionRootState.Unreachable) {
                    onRetryConnection
                } else {
                    null
                },
