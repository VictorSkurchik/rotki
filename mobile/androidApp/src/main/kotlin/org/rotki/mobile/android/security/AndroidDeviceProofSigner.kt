...
internal class AndroidDeviceProofSigner(
    ...
    override suspend fun createKeyForPairing(): DeviceProofPublicKeyOutcome = try {
    ...
    override suspend fun currentPublicKeyX963(): DeviceProofPublicKeyOutcome = try {
    ...
    override suspend fun deleteKey(): DeviceProofKeyDeleteOutcome = try {
    ...
    private suspend fun <T> onCryptoDispatcher(operation: () -> T): T =
