...
dependencies {
    ...
    implementation(project(":feature:authorization:application"))
    implementation(project(":feature:authorization:data"))
    implementation(project(":feature:authorization:domain"))
