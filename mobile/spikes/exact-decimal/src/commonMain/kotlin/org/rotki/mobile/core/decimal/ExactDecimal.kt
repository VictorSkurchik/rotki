...
public class ExactDecimal private constructor(
    ...
    public operator fun plus(other: ExactDecimal): ExactDecimal =
        ExactDecimal(backend.add(other.backend))

    public operator fun minus(other: ExactDecimal): ExactDecimal =
        ExactDecimal(backend.subtract(other.backend))

    public operator fun times(other: ExactDecimal): ExactDecimal =
        ExactDecimal(backend.multiply(other.backend))

    public operator fun div(other: ExactDecimal): ExactDecimal =
        ExactDecimal(backend.divide(other.backend))

    public fun toDisplayString(fractionDigits: Int): String =
        backend.toDisplayString(fractionDigits)
    ...
    public companion object {
        ...
        public fun parse(value: String): ExactDecimal =
            ExactDecimal(BigNumDecimalBackend.parse(value))
    }
}
