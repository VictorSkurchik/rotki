#!/usr/bin/env python3
"""Generate and verify the production ExactDecimal characterization vectors."""
...
MODEL_DIR: Final = Path(__file__).resolve().parents[1]
REPOSITORY_ROOT: Final = Path(__file__).resolve().parents[4]
VECTORS_PATH: Final = MODEL_DIR / 'test-vectors' / 'exact-decimal-v1.json'
KOTLIN_PATH: Final = (
    MODEL_DIR
...
def render_kotlin(vectors_json: str) -> str:
    ...
    return f'''// Generated by core/model/tools/generate_exact_decimal_vectors.py. Do not edit.
