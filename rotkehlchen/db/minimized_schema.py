...
# Created at 2026-08-13 15:19:09 UTC with rotki version 1.43.3.dev1141+g191756d0dc.d20260813 by Codex
MINIMIZED_USER_DB_SCHEMA = {
    ...
    "evm_internal_transactions": "parent_txintegernotnull,trace_idintegernotnull,from_addresstextnotnull,to_addresstext,valuetextnotnull,gastextnotnull,gas_usedtextnotnull,sourceintegernotnulldefault0,foreignkey(parent_tx)referencesevm_transactions(identifier)ondeletecascadeonupdatecascade,primarykey(parent_tx,trace_id,from_address,to_address,value,gas,gas_used)",
    ...
    "profile_metadata": "singletonintegernotnullprimarykeycheck(singleton=1),profile_idblobnotnulluniquecheck(typeof(profile_id)='blob'andlength(profile_id)=32)",
    ...
    "bitcoin_events_addresses": "event_identifierintegernotnull,addresstextnotnull,foreignkey(event_identifier)referenceshistory_events(identifier)onupdatecascadeondeletecascade,primarykey(event_identifier,address)",
    "bitcoin_transactions": "identifierintegernotnullprimarykey,locationchar(1)notnullreferenceslocation(location),tx_idtextnotnull,timestampintegernotnull,block_heightintegernotnull,feeintegernotnull,vin_countinteger,vout_countinteger,unique(location,tx_id)",
    "bitcoin_tx_io": "tx_idintegernotnull,directionintegernotnullcheck(directionin(1,2)),io_indexintegernotnull,valueintegernotnull,addresstext,scriptblob,primarykey(tx_id,direction,io_index),foreignkey(tx_id)referencesbitcoin_transactions(identifier)ondeletecascadeonupdatecascade",
    "bitcointx_address_mappings": "tx_idintegernotnull,addresstextnotnull,primarykey(tx_id,address),foreignkey(tx_id)referencesbitcoin_transactions(identifier)ondeletecascadeonupdatecascade",
    "bitcoin_tx_mappings": "tx_idintegernotnull,valueintegernotnull,primarykey(tx_id,value),foreignkey(tx_id)referencesbitcoin_transactions(identifier)ondeletecascadeonupdatecascade",
    ...
    "history_events_backup": "identifierintegernotnullprimarykey,entry_typeintegernotnull,group_identifiertextnotnull,sequence_indexintegernotnull,timestampintegernotnull,locationchar(1)notnulldefault('a')referenceslocation(location),location_labeltext,assettextnotnull,amounttextnotnull,notestext,typetextnotnull,subtypetextnotnull,extra_datatext,ignoredintegernotnulldefault0,foreignkey(asset)referencesassets(identifier)onupdatecascade,unique(group_identifier,sequence_index)",
    "chain_events_info_backup": "identifierintegerprimarykey,tx_refblobnotnull,counterpartytext,addresstext,foreignkey(identifier)referenceshistory_events_backup(identifier)onupdatecascadeondeletecascade",
    ...
    "ens_mappings": "addresstextnotnull,ens_nametextunique,last_updateintegernotnull,last_avatar_updateintegernotnulldefault0,sourcetextnotnulldefault'ens',primarykey(address,source)",
    ...
    "history_event_links": "left_event_idintegernotnull,right_event_idintegernotnull,link_typeintegernotnull,primarykey(left_event_id,link_type,right_event_id),foreignkey(left_event_id)referenceshistory_events(identifier)ondeletecascade,foreignkey(right_event_id)referenceshistory_events(identifier)ondeletecascade,unique(right_event_id,link_type)",
    "history_event_link_ignores": "event_idintegernotnull,link_typeintegernotnull,primarykey(event_id,link_type),foreignkey(event_id)referenceshistory_events(identifier)ondeletecascade",
    ...
    "solana_ata_address_mappings": "blockchaintextgeneratedalwaysas('solana')virtual,accounttextnotnull,ata_addresstextnotnull,primarykey(account,ata_address),foreignkey(blockchain,account)referencesblockchain_accounts(blockchain,account)ondeletecascade",
...
MINIMIZED_USER_DB_INDEXES = {
    ...
    "idx_timed_balances_currency_timestamp_category_value": "createindexifnotexistsidx_timed_balances_currency_timestamp_category_valueontimed_balances(currency,timestamp,category,usd_value)",
    "idx_bitcoin_events_addresses_address": "createindexifnotexistsidx_bitcoin_events_addresses_addressonbitcoin_events_addresses(address)",
    "idx_bitcoin_tx_io_address": "createindexifnotexistsidx_bitcoin_tx_io_addressonbitcoin_tx_io(address)",
    "idx_evm_transactions_chain_timestamp": "createindexifnotexistsidx_evm_transactions_chain_timestamponevm_transactions(chain_id,timestampdesc)",
    "idx_evmtx_address_mappings_address": "createindexifnotexistsidx_evmtx_address_mappings_addressonevmtx_address_mappings(address,tx_id)",
    "idx_zksynclite_transactions_from_timestamp": "createindexifnotexistsidx_zksynclite_transactions_from_timestamponzksynclite_transactions(from_address,timestampdesc)",
    "idx_zksynclite_transactions_to_timestamp": "createindexifnotexistsidx_zksynclite_transactions_to_timestamponzksynclite_transactions(to_address,timestampdesc)",
    "idx_solana_transactions_block_time": "createindexifnotexistsidx_solana_transactions_block_timeonsolana_transactions(block_timedesc)",
    "idx_solanatx_address_mappings_address": "createindexifnotexistsidx_solanatx_address_mappings_addressonsolanatx_address_mappings(address,tx_id)",
    "idx_bitcoin_transactions_location_timestamp": "createindexifnotexistsidx_bitcoin_transactions_location_timestamponbitcoin_transactions(location,timestampdesc)",
    "idx_bitcointx_address_mappings_address": "createindexifnotexistsidx_bitcointx_address_mappings_addressonbitcointx_address_mappings(address,tx_id)",
    "idx_history_event_links_right": "createindexifnotexistsidx_history_event_links_rightonhistory_event_links(right_event_id)",
    "idx_history_event_links_composite": "createindexifnotexistsidx_history_event_links_compositeonhistory_event_links(link_type,left_event_id,right_event_id)",
    "idx_history_event_link_ignores_type": "createindexifnotexistsidx_history_event_link_ignores_typeonhistory_event_link_ignores(link_type)",
    "idx_chain_events_info_tx_ref": "createindexifnotexistsidx_chain_events_info_tx_refonchain_events_info(tx_ref)",
    ...
    "idx_event_metrics_location_label": "createindexifnotexistsidx_event_metrics_location_labelonevent_metrics(location_label)",
