...
def test_writing_fetching_data(data_dir, username, sql_vm_instructions_cb):
    ...
    expected_dict = {
        ...
        'bridge_match_amount_tolerance': DEFAULT_BRIDGE_MATCH_AMOUNT_TOLERANCE,
        'bridge_match_time_range': DEFAULT_BRIDGE_MATCH_TIME_RANGE,
...
def test_timed_balances_inferred_zero_balances(data_dir, username, sql_vm_instructions_cb):
    ...
    assert len(all_data) == 319  # 5 from db + 312 ssf_graph_multiplier zeros + 2 inferred zeros
    data.logout()
