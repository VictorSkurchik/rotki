...
from rotkehlchen.api.v1.resources import (
    ...
    LatestBlockchainTransactionTimestampsResource,
...
URLS_V1: URLS = [
    ...
    ('/session/validate', SessionValidateResource),
    ...
    ('/blockchains/transactions/latest', LatestBlockchainTransactionTimestampsResource),
